...
&nbsp;&nbsp; $\color{#00FF41}\text{∟}$ $\color{#00FF41}\text{Metrics:}$ $\color{#00FF41}\text{80\\%}$ $\color{#00F0FF}\text{экономия времени}$ $\color{#00FF41}\text{•}$ $\color{#00FF41}\text{0}$ $\color{#00F0FF}\text{ошибок}$ $\color{#00FF41}\text{•}$ $\color{#00FF41}\text{30\\%}$ $\color{#00F0FF}\text{рост продуктивности}$  
